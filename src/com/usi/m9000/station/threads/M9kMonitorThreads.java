...
public class M9kMonitorThreads implements Callable<M9kKeyValuePair>
{
	String dfrName;
	String ipAddress;
	int port;
	M9kStationCommandClient commandClient;
	static org.apache.logging.log4j.Logger logger = org.apache.logging.log4j.LogManager.getLogger(M9kMonitorThreads.class);
	private final static String command = "MONITOR";
	
	public M9kMonitorThreads(String dfrName, String ipAddress, int port) {
		super();
