package com.usi.m9000.station.Test;
...
public class M9kStationDebugTestDFR extends JFrame implements ActionListener{
	...
	private JLabel lblSelecteFileName;
...
//	public String command;
	...
	private static StringBuffer powerSupplyProperty;
	File propertiesFile;
	/**
	...
	public M9kStationDebugTestDFR() {
		...
		try {
			propertiesFile = new File("station.properties");
	...
	private void initialize() {
		...
		powerSupplyProperty = new StringBuffer("[PowerSupply]");
		powerSupplyProperty.append(M9kStationConstants.NEWLINE);
		powerSupplyProperty.append("id=1");
		powerSupplyProperty.append(M9kStationConstants.NEWLINE);
		powerSupplyProperty.append("ip-address=192.168.1.100");
		powerSupplyProperty.append(M9kStationConstants.NEWLINE);
		powerSupplyProperty.append("port=9978");
		powerSupplyProperty.append(M9kStationConstants.NEWLINE);
		menuBar = new JMenuBar();
		createAndAddMenu();
		fc = new JFileChooser("~/M9K");
...
//			lblTitle.setPreferredSize(new Dimension(15, 30));
			...
			btnSelectFile = new JButton("Click to Select");
			btnSelectFile.addActionListener(this);

			lblSelecteFileName = new JLabel();
			...
			pnlSelectFile.add(lblSelecteFileName);
...
//					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
			...
			for (String dfr : dfrs) {
				if (!dfr.toUpperCase().startsWith("DFR") &&  !dfr.toUpperCase().startsWith("POWERSUPPLY"))
				{
					continue;
				}
...
//			jScrollPane.setBounds(new Rectangle(3, 150, 946, 793));
			...
			jspFileCommands.setMinimumSize(new Dimension(200,400));
...
//			System.out.println("Event["+i+"]\t: "+(( brddet & (1 << (22-i))) > 0 ? "present" : "empty" ) );
	...
	private void createEditMenuItems()
	{
		...
		rbDebugMenuItem = new JRadioButtonMenuItem("Debug Mode");
		...
		rbTestMenuItem = new JRadioButtonMenuItem("Test Mode");
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (source.equalsIgnoreCase("Debug Mode"))
		{
		...
		else if (source.equalsIgnoreCase("Test Mode"))
		{
		...
		else if (source.equalsIgnoreCase("Click to Select"))
		{
			System.out.println("Clicked to open a file");
			int returnVal = 0;
			returnVal = fc.showOpenDialog(this);
				if (returnVal == JFileChooser.APPROVE_OPTION) {
				    selectedFile = fc.getSelectedFile();
				    System.out.println("file selected..."+selectedFile.getName());
				    lblSelecteFileName.setText(selectedFile.getName());
