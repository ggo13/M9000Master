...
<div id="divNewVirtuals">
		<s:form id="frmNewDialog" action="createVirtualMeasurements" method="post" cssStyle="height:100%;width:100%"  theme="xhtml">
				<tr>
										...
										<div>
											...
											<div>
												<s:textfield  theme="simple" cssStyle="width:20%" 
													id="globalScale"
													name="globalScale"
													value="%{globalScale}" disabled="true"  onkeyup="updateGlobalScale(this.value);"
													></s:textfield>
											</div>
										</div>
									</div>
					...
					<td colspan="2" align="center">
						...
						<div id="divCreateVirtualChannels">
							<s:submit theme="simple" cssClass="submit" name="btnCreate"
								value="Save"  action="createVirtualMeasurement"/>
							<s:submit theme="simple" cssClass="submit" name="btnCancel"
								value="Cancel" onclick="$.publish('closeNewDialogTopic');return false;" />
						</div>
					</td>
				</tr>
