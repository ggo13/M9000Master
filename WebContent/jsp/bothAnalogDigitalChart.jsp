...
<link href="<s:url value="/css/scopeTab.css"/>" rel="stylesheet" type="text/css" />
...
<script src="js/m9000/scopeResize.js"></script>
	...
	<s:url var="displayDigitalPanel" action="getScopeDigitalInfo">
	</s:url>
	<div id="chartMenu" style="width:100%;">
		<s:checkbox theme="simple" id="showHideAnalog"
		name="showHideAnalog" value="true" title="Show or Hide Analog chart panel"
		cssClass=".tdLabel" />
		<s:label theme="simple" name="lblShowHideAnalog" value="Show Analog" title="Show or Hide Analog chart panel" for="showHideAnalog"
		cssClass="titleLabel" />
		...
		name="showHideDataPoints" title="Show or Hide Data Points in analog chart"
		cssClass=".tdLabel" />
		...
		cssClass="titleLabel" />
		<s:checkbox theme="simple" id="showHideDigital"
		name="showHideDigital" value="true" title="Show or Hide Digitals in the bottom panel"
		cssClass=".tdLabel" />
		<s:label theme="simple" name="lblShowHideDigital" value="Show Digital" title="Show or Hide Digitals in the bottom panel" for="showHideDigital"
		cssClass="titleLabel" />
		...
		cssClass="titleLabel" />
			...
			<div id="splitPane" class="resizable resizable1" style="height:calc(100vh - 250px)">
				<div class="left-side-scope" style="width:100%;height:100%">
					<div id="divAnalogChart" class="divAnalog h-resizable h-resizable-top">
					...
					<sj:div class="h-resizable h-resizable-bottom" id="divDigital" deferredLoading="true" href="%{#displayDigitalPanel}" reloadTopics="updateDigitalInfo"></sj:div>
				</div>
		</div>
		<div id="controls" class="resizable resizable2"> 
			...
			<sj:accordion id="idAccordion0" heightStyle="content" animate="true" collapsible="true">
				<sj:accordionItem title="Primary or Secondary">
					<div class="controlsDiv">
						<s:radio label="Display" id="primaryOrSecondaryDisplay" name="primaryOrSecondaryDisplay" list="{'P', 'S'}" value="primaryOrSecondaryDisplay" title="Select Primary or Secondary"/>
					</div>
				</sj:accordionItem>
			</sj:accordion>
				...
				<sj:accordionItem title="Select Channels">
					<div class="controlsDiv">
						...
						<sj:dialog id="selectAnalogDialog" 
							...
							autoOpen="false" modal="true" title="Analog Channels" width="350" >
					...
					<div class="controlsDiv">
						...
						<s:submit theme="simple" name="btnNext" value="Next" title="Display Next Channel" onclick="return false;"/>
						<s:submit theme="simple" name="btnPrevious" value="Previous" title="Display Previous Channel" disabled="true" onclick="return false;"/>
					</div>
				</sj:accordionItem>
			</sj:accordion>
			<sj:accordion id="idAccordion2" heightStyle="content" animate="true" collapsible="true">
				<sj:accordionItem title="Select Cycles">
					<div class="controlsDiv">
						...
						<s:submit theme="simple" name="btnApply" value="Apply" title="Click to request the set cycle" onclick="return false;"/>
					</div>
				</sj:accordionItem>
			</sj:accordion>
			...
			<sj:accordion id="idAccordion5" heightStyle="content" animate="true" collapsible="true">
				<sj:accordionItem title="External Calibration">
					...
					<div class="controlsDiv">
						...
						<sj:dialog id="dlgShowExternalCal" closeOnEscape="false" width="auto" height="auto" 
						...
						<sj:dialog id="dlgShowExternalCalReset" closeOnEscape="false" width="auto" height="auto" 
