...
<s:if test="%{lstDfrsAnalogChannels.size > 0}">
        <td colspan="2"><s:label theme="simple" cssClass="titleLabel"
                        value="Available Channels List"></s:label> <s:select
                        cssStyle="font-family:courier, courier new, serif;border-style: solid solid solid solid"
	...
	<td>
					...
					<s:submit theme="simple" cssClass="submit" name="btnAdd"
						value="Add" cssStyle="font-weight:normal;width:100%"
						onclick="javascript:populateDecisionLogic(this.value);return false;" disabled="true"/>
				</td></tr>
				<tr><td>
					<s:submit theme="simple" cssClass="submit" name="btnSub"
						value="Subtract" cssStyle="font-weight:normal;width:100%"
						onclick="javascript:populateDecisionLogic(this.value);return false;" disabled="true"/>
				</td></tr>
				<tr><td>
					<s:submit theme="simple" cssClass="submit" name="btnDelete"
						value="Delete" cssStyle="font-weight:normal;width:100%"
						onclick="javascript:populateDecisionLogic(this.value);return false;" />
				</td></tr>
				<tr><td>
					<s:submit theme="simple" cssClass="submit" name="btnClear"
						value="Clear" cssStyle="font-weight:normal;width:100%"
						onclick="javascript:populateDecisionLogic(this.value);return false;" />
				</td></tr>
				</table>
			</td>
